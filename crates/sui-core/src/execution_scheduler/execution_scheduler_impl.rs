...
mod test {
    ...
    async fn execution_scheduler_reconfigure() {
        // Checks that when we enable balance withdraw scheduler during epoch change,
        // the balance withdraw scheduler would go from None to Some, and properly initialized.
