...
use move_vm_runtime::{
    dev_utils::{gas_schedule::CostTable, vm_arguments::allocate_args_for_call},
...
pub fn run(
    ...
    let res = {
        ...
        let vm_args = allocate_args_for_call(
            &vm_instance,
            &module.self_id(),
            function,
            &type_args,
        ...
        .expect("failed to convert MoveValue to runtime value");
